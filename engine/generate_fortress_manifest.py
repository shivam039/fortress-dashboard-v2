...
try:
    from fortress_config import SECTOR_MAP, TICKER_GROUPS
except ImportError:
...
def generate_manifest():
    manifest = {
        ...
        "mathematical_core": {
            ...
            "integrity_thresholds": {
                ...
                "tracking_error_limits": {"Large Cap": 6.0, "Others": 9.0},
                "beta_limits": {
                    "Large Cap": 1.15,
    ...
    print(
        f"📊 Ticker Groups Imported: {len(manifest['data_schema']['dynamic_config']['ticker_groups'])}"
    )
