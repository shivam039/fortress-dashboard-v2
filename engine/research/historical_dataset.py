...
FEATURES = (
    ...
    'EMA_Alignment', 'Perfect_Alignment', 'Supertrend_Bullish', 'ADX_14',
    'Breakout_Confirmed', 'Breakout', 'VCP', 'VCP_Coiling',
    'EMA200_Extension_Pct', 'Overextended', 'Feature_Contributions',
